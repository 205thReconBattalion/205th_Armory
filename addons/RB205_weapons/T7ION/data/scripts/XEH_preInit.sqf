...
RB205_T7ION_DamageVehicleFunc = {
    _AOE = 15;
    {
		...
		_e_static setParticleParams [["\A3\data_f\blesk1", 1, 0, 1], "", "SpaceObject", 1, 0.35, [0, 0, 0], [0, 0, -2], 0.05, 10, 7.9,0, [0, 0.0175, 0], [[1, 1, 0.1, 1], [1, 1, 1, 1]], [0.01], 1, 0, "", "", _x, 0, false, -1, [[100,100,100,1],[0,0,1,0.01]]];
		...
		_x setHitPointDamage ["#light_hitpoint",1];
		...
		_x setHitPointDamage ["HitHRotor",1];
		_x setHitPointDamage ["HitVRotor",1];
		_x setHitPointDamage ["HitHydraulics",1];
		_x setHitPointDamage ["HitHStabilizerL1",1];
		_x setHitPointDamage ["HitHStabilizerR1",1];
		_x setHitPointDamage ["HitVStabilizer1",1];
