...
class RscHiddenButton: RscButton
{
	idc = -1;
	type = CT_BUTTON;
	text = """";
...
class Button_transparent: RscButton
{
	type = CT_BUTTON;
	idc = -1;
	text = """";
...
class DBUG_RscCombo: RscCombo
{
	idc = -99;
	onSetFocus = ""call DBUG_fnc_handleFocus"";
	onLoad = ""call DBUG_fnc_initCtrl"";
	font = ""PuristaMedium"";
	sizeEx = 0.9*(GUI_GRID_WAbs / 30);
};
class DBUG_RscListBox: RscListBox
{
	idc = -99;
	onSetFocus = ""call DBUG_fnc_handleFocus"";
	onLoad = ""call DBUG_fnc_initCtrl"";
	...
	style = LB_TEXTURES;
	colorText[] = {1,1,1,1};
	sizeEx = 0.75 * (GUI_GRID_WAbs / 30);
	font = ""EtelkaMonospacePro"";
	rowHeight = (GUI_GRID_WAbs / 30);
...
class DBUG_RscEdit
{
	...
	colorBackground[] = {0,0,0,0};
	colorDisabled[] = {1,1,1,0};
	colorSelection[] = {1,1,1,0.15};
	colorText[] = {1,1,1,1};
	deletable = 0;
	fade = 0;
	font = ""EtelkaMonospacePro"";
	sizeEx = 0.75 * (GUI_GRID_WAbs / 30);
	h = 1.25 * (GUI_GRID_WAbs / 30);
	onMouseButtonDown = ""ctrlSetFocus (_this select 0)"";
	shadow = 0;
	style = ST_LEFT;
	linespacing = 1;
	text = """";
...
class DBUG_frame: RscFrame
{
	...
	isDisabled = 1;
	font = ""PuristaMedium"";
	sizeEx = 0.8 * (GUI_GRID_WAbs / 30);
};
class DBUG_ListNBox: RscListNBox
{
	alwaysVisible = 1;
	disableOverflow = 1;
	onSetFocus = ""call DBUG_fnc_handleFocus"";
	...
	colorSelectBackground[] = {0.5,0.5,0.5,0.1};
	colorSelectBackground2[] = {0.5,0.5,0.5,0.1};
	colorBackground[] = {0,0,0,0.2};
	sizeEx = 0.9 * (GUI_GRID_WAbs / 30);
	font = ""RobotoCondensed"";
	rowHeight = 1 * (GUI_GRID_WAbs / 30);
};
class DBUG_RscEditLocked: DBUG_RscEdit
{
	canModify = 0;
};
class DBUG_MENU_STRIP: ctrlMenuStrip
{
	...
	arrow = ""\a3\3DEN\Data\Controls\ctrlMenu\arrow_ca.paa"";
	rowHeight = 0;
	itemSpacingW = 0.25 * GUI_GRID_W;
	itemSpacingH = 0.25 * (GUI_GRID_WAbs / 30);
	pictureCheckboxEnabled = ""\a3\3DEN\Data\Controls\CtrlMenu\pictureCheckboxEnabled_ca.paa"";
	pictureCheckboxDisabled = ""#(argb,8,8,3)color(0,0,0,0)"";
	pictureRadioEnabled = ""\a3\3DEN\Data\Controls\CtrlMenu\pictureRadioEnabled_ca.paa"";
	pictureRadioDisabled = ""#(argb,8,8,3)color(0,0,0,0)"";
...
class DBUG_Button: RscButton
{
	...
	offsetPressedY = 0;
	shadow = 0;
	onButtonUp = ""_window = (_this select 0) call DBUG_fnc_getWindow; ctrlSetFocus (_window getVariable ['DBUG_focusCtrl', controlNull])"";
	style = ST_MULTI + ST_TITLE_BAR + ST_KEEP_ASPECT_RATIO;
};
class DBUG_ButtonTXT: DBUG_Button
{
	style = ST_CENTER;
...
class cba_settings_ButtonConfigure_base: RscButtonMenu
{
...
class cba_settings_OptionsGroup: RscControlsGroupNoHScrollbars
{
	x = ((0) * GUI_GRID_W);
	y = ((3.5) * GUI_GRID_H);
	w = ((37.5) * GUI_GRID_W);
	h = ((13.8) * GUI_GRID_H);
	lineHeight = ((1) * GUI_GRID_H);
	class VScrollbar: VScrollbar
	{
		thumb = ""\a3\3DEN\Data\Controls\ctrlDefault\thumb_ca.paa"";
		border = ""\a3\3DEN\Data\Controls\ctrlDefault\border_ca.paa"";
...
class cba_settings_RscCombo: RscCombo
{
	arrowFull = ""\a3\3DEN\Data\Controls\ctrlCombo\arrowFull_ca.paa"";
	arrowEmpty = ""\a3\3DEN\Data\Controls\ctrlCombo\arrowEmpty_ca.paa"";
...
class cba_settings_AddonsList: cba_settings_RscCombo
{
	linespacing = 1;
	text = """";
...
class cba_settings_CheckboxSound: RscCheckBox
{
	soundEnter[] =
	{
		""\a3\ui_f\data\Sound\RscButtonMenu\soundEnter"",
...
class cba_settings_Row_Empty: RscText
{
	cba_settings_script = """";
	x = ((1) * GUI_GRID_W);
	y = ((0) * GUI_GRID_H);
...
class cba_ui_ItemContextMenu: RscListBox
{
...
class ace_slideshow_mapNormal: ctrlMap
{
	maxSatelliteAlpha = 0;
	sizeExLabel = 0;
	sizeExUnits = 0;
...
class ace_slideshow_mapTopo: ace_slideshow_mapNormal
{
	drawShaded = 0.35;
	shadedSea = 0.35;
	sizeExLevel = 0.02;
...
class ace_slideshow_mapSat: ace_slideshow_mapNormal
{
...
class ace_arsenal_customArsenalButton_Button: RscButtonArsenal
{
	...
	text = ""\z\ace\addons\arsenal\data\iconCustom.paa"";
	tooltip = """";
	onButtonClick = ""[ctrlParent (_this select 0), _this select 0] call ace_arsenal_fnc_fillRightPanel"";
	colorBackground[] = {0,0,0,0.5};
};
class ace_arsenal_customArsenalButton_Background: ctrlStaticBackground
{
...
class Rsc_ACE_CallScreen_Edit: RscEdit
{
	...
	text = """";
	style = ST_FRAME + ST_NO_RECT;
	shadow = 1;
	SizeEx = ((GUI_GRID_HAbs / 20) * 1);
...
{
	size = (   (   (   GUI_GRID_WAbs / 1.2) / 25) * 0.66);
	class Attributes
	{
		align = ""right"";
		color = ""#070103"";
...
class OPTRE_HUD_rscMapControl_HUD_1: RscMapControl
{
	...
	fontUnits = ""TahomaB"";
	h = SafeZoneH - 1.5 *      (   (   GUI_GRID_WAbs / 1.2) / 25);
	idc = 51;
	idcMarkerColor = -1;
	idcMarkerIcon = -1;
	maxSatelliteAlpha = 0;
	...
	sizeEx = 0.04;
	sizeExGrid = 0.02;
	sizeExInfo = (   (   (   GUI_GRID_WAbs / 1.2) / 25) * 0.8);
	sizeExLabel = (   (   (   GUI_GRID_WAbs / 1.2) / 25) * 0.8);
	sizeExLevel = 0.02;
	sizeExNames = (   (   (   GUI_GRID_WAbs / 1.2) / 25) * 0.8) * 2;
	sizeExUnits = (   (   (   GUI_GRID_WAbs / 1.2) / 25) * 0.8);
	stickX[] =
	{
		0.2,
		""[""""Gamma"""""",
	...
	w = ""SafeZoneWAbs"";
	x = ""SafeZoneXAbs"";
	y = SafeZoneY + 1.5 *      (   (   GUI_GRID_WAbs / 1.2) / 25);
	class LineMarker
	{
		textureComboBoxColor = ""#(argb,8,8,3)color(0,0,0,0)"";
		lineDistanceMin = 3e-005;
...
{
	idc = -1;
	onButtonClick = ""[ctrlParent (_this select 0)] call ace_medical_gui_fnc_toggleTriageSelect"";
	x = ((13.83) * GUI_GRID_W + (safezoneX + (safezoneW - GUI_GRID_WAbs)/2));
	y = ((15.5) * GUI_GRID_H + (safezoneY + (safezoneH - GUI_GRID_HAbs)/2));
	w = ((12.33) * GUI_GRID_W);
	h = ((1.1) * GUI_GRID_H);
	colorFocused[] = {0,0,0,0};
	colorBackground[] = {0,0,0,0};
...
class ace_xm157_textMenu: ace_xm157_text
{
	SizeEx = 0.09;
	style = ST_CENTER + ST_MULTI;
};
