...
class cfgWeapons
{
	...
	class RB205_U_ab_trooper_chimaera: RB205_U_trooper
	{
		ACCESS_TRUE
		displayName = "[205] Clone Airborne Trooper Armor <1-2 Chimaera>";
		class ItemInfo: ItemInfo
		{
...
class cfgVehicles
{
	...
	class RB205_clone_ab_trooper_chimaera: RB205_clone_ab_trooper
	{
		...
		uniformclass = "RB205_U_ab_trooper_chimaera";
		editorSubcategory = "RB205_squadVariants";
		hiddenselectionsTextures[] =
		{
