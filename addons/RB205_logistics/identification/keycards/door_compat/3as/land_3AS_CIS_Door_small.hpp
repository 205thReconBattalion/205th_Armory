...
class RB205_keycard_door_red_land_3AS_CIS_Door_small: land_3AS_CIS_Door_small {
...
class RB205_keycard_door_orange_land_3AS_CIS_Door_small: land_3AS_CIS_Door_small {
    editorCategory = EDITOR_CATEGORY;
...
class RB205_keycard_door_yellow_land_3AS_CIS_Door_small: land_3AS_CIS_Door_small {
    editorCategory = EDITOR_CATEGORY;
...
class RB205_keycard_door_green_land_3AS_CIS_Door_small: land_3AS_CIS_Door_small {
    editorCategory = EDITOR_CATEGORY;
...
class RB205_keycard_door_blue_land_3AS_CIS_Door_small: land_3AS_CIS_Door_small {
    editorCategory = EDITOR_CATEGORY;
    editorSubcategory = EDITOR_SUBCATEGORY_BLUE;
    class UserActions {
        class OpenDoor {
            USER_ACTION_OPEN
            condition = "(('RB205_keycard_blue' in items player || 'RB205_tseries_head_blue' in items player || 'RB205_keycard_master' in items player) && ((this animationPhase 'open_left') < 0.5))";
            position = "door_Action";
            statement = "[this,'open_left',2] call BIS_fnc_DoorNoHandleOpen;[this,'open_right',2] call BIS_fnc_DoorNoHandleOpen";
        };
        class CloseDoor: OpenDoor {
