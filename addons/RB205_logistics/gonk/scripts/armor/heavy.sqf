...
player addBackpack "RB205_B_heavy";
...
// PRIMARY WEAPON
player addWeapon "RB205_Z6";
player addPrimaryWeaponItem "RB205_RapidFire_Energy_Pack";
// SECONDARY WEAPON
...
// VEST
for "_i" from 1 to 6 do {player addItemToVest "RB205_RapidFire_Energy_Pack";};
...
// BACKPACK
for "_i" from 1 to 15 do {player addItemToBackpack "RB205_Standard_Energy_Pack";};
for "_i" from 1 to 5 do {player addItemToBackpack "RB205_Overcharged_Energy_Pack";};
for "_i" from 1 to 5 do {player addItemToBackpack "RB205_Compact_Energy_Pack";};