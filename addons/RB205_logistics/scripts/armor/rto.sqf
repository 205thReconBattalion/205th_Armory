...
player addBackpack "RB205_B_radio";
...
// BACKPACK
player addItemToBackpack "205_holoProjector";
for "_i" from 1 to 5 do {player addItemToBackpack "RB205_smokeBlue";};
for "_i" from 1 to 3 do {player addItemToBackpack "RB205_smokeGreen";};
for "_i" from 1 to 3 do {player addItemToBackpack "RB205_smokeRed";};
for "_i" from 1 to 3 do {player addItemToBackpack "ACE_HandFlare_Red";};