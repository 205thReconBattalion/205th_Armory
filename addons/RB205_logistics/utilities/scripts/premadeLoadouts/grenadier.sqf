...
for "_i" from 1 to 2 do {player addItemToVest "RB205_ugl_smoke_red";};
for "_i" from 1 to 2 do {player addItemToVest "RB205_ugl_flare_white";};
for "_i" from 1 to 2 do {player addItemToVest "RB205_ugl_huntir";};