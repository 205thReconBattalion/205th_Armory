class XtdGearInfos
{
    class CfgWeapons
	{
        ...
        {
            model = "aceax_compat_RB205_empire_H_officer";
            affiliation = "navy1";
            variant = "dft";
        };
        ...
        {
            model = "aceax_compat_RB205_empire_U_officer";
            affiliation = "navy1";
            variant = "dft";
        };
        ...
        {
            model = "aceax_compat_RB205_empire_V_officer";
            affiliation = "navy1";
            rank = "ens";
            variant = "dft";
        };
        ...
        {
            model = "aceax_compat_RB205_empire_H";
            type = "dft";
            variant = "dft";
        };
        ...
        {
            model = "aceax_compat_RB205_empire_U";
            type = "dft";
            variant = "dft";
        };
        ...
        {
            model = "aceax_compat_RB205_empire_V";
            type = "dft";
            rank = "ct";
            variant = "dft";
        };
    ...
    class CfgVehicles
	{
        ...
        {
            model = "aceax_compat_RB205_empire_B";
            type = "dft";
            role = "heavy";
        };
